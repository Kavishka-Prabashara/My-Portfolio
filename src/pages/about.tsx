...
function About() {
    ...
    return (
        <motion.section
            ...
            className="flex flex-col md:flex-row items-center justify-between p-6 sm:p-10 bg-white rounded-xl mx-4 sm:mx-10"
        >
            ...
            >
                <div className="flex flex-col sm:flex-row items-center md:items-start gap-3">
                    ...
                    <h2 className="text-2xl sm:text-3xl font-bold">Who is Kavishka?</h2>
                </div>
